                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="mengajar" class="form-control @error('mengajar') is-invalid @enderror">
                                            ...
                                            <option value="Konten Kreator" {{$pengajar->userDetail->mengajar == 'Konten Kreator' ? 'selected' : ''}} >Konten Kreator</option>
                                            <option value="Videoraphy" {{$pengajar->userDetail->mengajar == 'Videoraphy' ? 'selected' : ''}} >Videoraphy</option>
                                            <option value="Photography" {{$pengajar->userDetail->mengajar == 'Photography' ? 'selected' : ''}} >Photography</option>
                                            <option value="Tata Busana" {{$pengajar->userDetail->mengajar == 'Tata Busana' ? 'selected' : ''}} >Tata Busana</option>
                                            <option value="Tata Kecantikan" {{$pengajar->userDetail->mengajar == 'Tata Kecantikan' ? 'selected' : ''}} >Tata Kecantikan</option>
                                            <option value="Disain Komunikasi Visual" {{$pengajar->userDetail->mengajar == 'Disain Komunikasi Visual' ? 'selected' : ''}} >Disain Komunikasi Visual</option>
